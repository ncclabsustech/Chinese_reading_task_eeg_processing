...
align_eeg_with_sentence(eeg_path='sub-07_ses-LittlePrince_task-reading_run-01_eeg.vhdr', novel_path='segmented_Chinense_novel.xlsx', start_index=1, end_index=4)